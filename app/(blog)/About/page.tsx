  ...
  return (
    <div className="about flex flex-col md:flex-row items-center bg-white p-8 md:p-16">
      ...
      <div className="w-full md:w-1/2 mt-8 md:mt-0 md:pl-12">
        ...
        <h2 className="text-xl text-purple-600 font-semibold mb-4">Ghufran Shah - Developer</h2>
        <p className="text-gray-600 mb-6">
          I have built this blog website. 
          The website includes modern technologies like Sanity CMS to fetch and manage data efficiently. 
